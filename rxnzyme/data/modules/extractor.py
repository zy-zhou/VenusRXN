...
from ..datasets.prorxn import EnzymeDataset, RxnzymeDataset
...
class Enzyme2EnzymeDataModule(LightningDataModule):
    def __init__(
        self,
        enz_db_path,
        tokenizer,
    ...
    def setup(self, stage='test'):
        if stage == 'test':
            ...
            self.pred_query_indices = torch.tensor(
                [enz_id_to_idx[enz_id] for enz_id in self.pred_query_ids]
            )
