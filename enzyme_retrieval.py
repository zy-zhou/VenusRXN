...
def parse_args():
    ...
    parser.add_argument('--rxn_db_dir', '-rdb', type=str, default='data/retrieval_benchmark/rxn_db')
    parser.add_argument('--enz_db_path', '-edb', type=str, default='data/retrieval_benchmark/enz_db.json')
    parser.add_argument('--train_ids_path', '-tid', type=str, default='data/retrieval_benchmark/train_pairs.tsv')
    parser.add_argument('--test_ids_path', '-sid', type=str, default='data/retrieval_benchmark/test_pairs.tsv')
    ...
    parser.add_argument('--ckpt_path', '-ckpt', type=str, default='checkpoints/model.ckpt')
